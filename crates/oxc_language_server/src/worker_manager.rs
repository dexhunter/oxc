...
impl WorkerManager {
    ...
    fn find_worker_index_for_uri(workers: &[WorkspaceWorker], uri: &Uri) -> Option<usize> {
        if !uri.as_ref().starts_with("file://") {
...
mod tests {
    ...
    async fn test_get_worker_for_uri_nested_workspaces() {
        let workspace = WorkspaceWorker::new(
            Uri::from("file:///path/to/workspace"),
            create_builder(),
            DiagnosticMode::None,
        );
        let workspace_deeper = WorkspaceWorker::new(
            Uri::from("file:///path/to/workspace/deeper"),
            create_builder(),
            DiagnosticMode::None,
        );
        ...
        let file_in_deeper = Uri::from("file:///path/to/workspace/deeper/file.js");
        ...
        let file_in_parent = Uri::from("file:///path/to/workspace/file.js");
        ...
        let file_outside = Uri::from("file:///path/to/other/file.js");
    ...
    async fn test_get_worker_for_uri_similar_names() {
        ...
        let workspace2 = WorkspaceWorker::new(
            Uri::from("file:///path/to/workspace-2"),
            create_builder(),
            DiagnosticMode::None,
        );
        ...
        let file_in_workspace2 = Uri::from("file:///path/to/workspace-2/file.js");
        ...
        let file_in_workspace = Uri::from("file:///path/to/workspace/file.js");
    ...
    async fn test_get_worker_for_uri_no_workers() {
        ...
        let file = Uri::from("file:///path/to/workspace/file.js");
    ...
    async fn test_get_worker_for_uri_vscode_user_data_single_workspace() {
        ...
        let vscode_userdata_file = Uri::from("vscode-userdata:///Untitled-1");
        let manager = WorkerManager::new(create_builder());
        manager.start_manager(workers, DiagnosticMode::None).await;
    ...
    async fn test_get_worker_for_uri_untitled_single_workspace() {
        ...
        // non file URI should use first workspace
        let untitled_file = Uri::from("untitled:///Untitled-1");
        let manager = WorkerManager::new(create_builder());
        manager.start_manager(workers, DiagnosticMode::None).await;
    ...
    async fn test_get_worker_for_uri_untitled_multiple_workspaces() {
        let workspace1 = WorkspaceWorker::new(
            Uri::from("file:///path/to/workspace1"),
            create_builder(),
            DiagnosticMode::None,
        );
        let workspace2 = WorkspaceWorker::new(
            Uri::from("file:///path/to/workspace2"),
            create_builder(),
            DiagnosticMode::None,
        );
    ...
    fn test_get_parent_dir_uri() {
        ...
        // Typical file URI
        let file = Uri::from("file:///path/to/dir/file.js");
        ...
        let root_file = Uri::from("file:///file.js");
        ...
        let no_path_file = Uri::from("file:///");
    ...
    async fn test_get_worker_for_uri_dynamic_with_workspaces_with_workspaces() {
        ...
        let file_outside = Uri::from("file:///other/path/file.js");
        let worker = manager.get_worker_for_uri(&file_outside).await;
        assert!(worker.is_some());
        assert_eq!(worker.unwrap().get_root_uri().to_string(), "file:///");

        // Files inside workspace should match the workspace worker
        let file_inside = Uri::from("file:///path/to/workspace/file.js");
